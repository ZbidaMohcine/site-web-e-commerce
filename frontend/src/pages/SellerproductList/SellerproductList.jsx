...
export default function SellerproductList() {
  ...
  // const res = await axios.get("http://localhost:8080/ProductImage/getImage/"+id);
  // setPhoto(res.data);
  // }
  ...
  const columns = [
    { field: "id", headerName: "ID", width: 90 },
    {
      ...
      renderCell: (params) => {
        ...
        // ShowImage(params.row.id);

        return (
          <div className="productListItem">
            {/* <img className="productListImg" src={params.row.productPhoto} alt="" /> */}
